...
export const listBoardsSchema = z.object({
  ...
  expand: stringOrStringArray.optional().describe('Expand options (e.g., "admins,permissions"). Accepts a comma-separated string or an array.')
});
...
export const registerListBoardsTool = (server: ToolRegistrar) => {
  server.tool(
    'listBoards',
