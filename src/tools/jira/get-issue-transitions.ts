...
export const getIssueTransitionsSchema = z.object({
  ...
  expand: stringOrStringArray.optional().describe('Expand options for transitions (e.g., "transitions.fields"). Accepts a comma-separated string or an array.')
});
...
export const registerGetIssueTransitionsTool = (server: ToolRegistrar) => {
  server.tool(
    'getIssueTransitions',
