...
export const listProjectVersionsSchema = z.object({
  ...
  expand: stringOrStringArray.optional().describe('Additional details to include (e.g., issuesstatus, operations). Accepts a comma-separated string or an array.')
});
...
export const registerListProjectVersionsTool = (server: ToolRegistrar) => {
  server.tool(
    'listProjectVersions',
