...
export const getProjectSchema = z.object({
  ...
  expand: stringOrStringArray.optional().describe('Expand additional information (e.g., "description,lead,issueTypes,url,projectKeys"). Accepts a comma-separated string or an array.')
});
...
export const registerGetProjectTool = (server: ToolRegistrar) => {
  server.tool(
    'getProject',
