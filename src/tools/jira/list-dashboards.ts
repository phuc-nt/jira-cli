...
export const listDashboardsSchema = z.object({
  ...
  expand: stringOrStringArray.optional().describe('Expand options for dashboards. Accepts a comma-separated string or an array.')
});
...
export const registerListDashboardsTool = (server: ToolRegistrar) => {
  server.tool(
    'listDashboards',
