...
export const listProjectsSchema = z.object({
  expand: stringOrStringArray.optional().describe('Expand additional project information (e.g., "description,lead,url"). Accepts a comma-separated string or an array.'),
...
export const registerListProjectsTool = (server: ToolRegistrar) => {
  server.tool(
    'listProjects',
