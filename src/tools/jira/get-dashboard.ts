...
export const getDashboardSchema = z.object({
  ...
  expand: stringOrStringArray.optional().describe('Expand options (e.g., "description,owner,viewUrl,favourite,favouritedCount,sharePermissions,editPermissions"). Accepts a comma-separated string or an array.')
});
...
export const registerGetDashboardTool = (server: ToolRegistrar) => {
  server.tool(
    'getDashboard',
