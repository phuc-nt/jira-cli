...
export const getMyFiltersSchema = z.object({
  ...
  expand: stringOrStringArray.optional().describe('Expand options (e.g., "description,owner,jql,viewUrl,searchUrl,favourite,favouritedCount,sharePermissions,editPermissions,subscriptions"). Accepts a comma-separated string or an array.')
});
...
export const registerGetMyFiltersTool = (server: ToolRegistrar) => {
  server.tool(
    'getMyFilters',
