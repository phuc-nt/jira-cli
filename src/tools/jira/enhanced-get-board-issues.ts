...
export const enhancedGetBoardIssuesSchema = z.object({
  ...
  // Response control
  fields: stringOrStringArray.optional().describe('Comma-separated fields to include (default: summary,status,assignee,reporter,priority). Accepts a comma-separated string or an array.'),
  expand: stringOrStringArray.optional().describe('Expand options (names,schema,operations). Accepts a comma-separated string or an array.'),
...
// Tool registration
export const registerEnhancedGetBoardIssuesTool = (server: ToolRegistrar) => {
  server.tool(
    'getBoardIssues',
